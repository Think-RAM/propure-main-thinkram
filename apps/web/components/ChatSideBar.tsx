...
import { ArrowDownIcon, SendHorizonalIcon, SparklesIcon } from "lucide-react";
      ...
      <div className="flex-1 min-h-0">
        <ScrollArea className="h-full px-4 py-3">
          ...
          >
            ...
            {error && (
              <div
                className="max-w-[85%] rounded-lg bg-red-100/70 text-red-900 self-center px-3 py-2 text-sm leading-relaxed"
              >
                {error.message || "An error occurred while processing your chat."}
              </div>
            )}
